<nav class="bg-gray-900 navbar" x-data="{open:false}">
    <style>
        .navbar {
            /* overflow: hidden; */
            position: fixed;
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            @auth
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <!-- Profile dropdown -->
                    <div class="ml-3 relative brand-menu" x-data="{open:false}">
                        <div>
                            <button x-on:click="open = true"
                        ...
                        <div x-show="open" x-on:click.away="open=false"
                            ...
                            <a href="{{ route('profile.show') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300" role="menuitem">Perfil</a>
                            <a href="{{ route('admin.home') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300" role="menuitem">Administración</a>
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <a href="{{ route('logout') }}"
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300" role="menuitem" onclick="event.preventDefault();
